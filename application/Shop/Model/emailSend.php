<?php
	...
	use think\Validate;
	class emailSend extends \think\Model
	{
		public static $email_config = [
			'host'			=> 'smtp.exmail.qq.com',//邮箱host地址
			'username' 		=> '541891006@qq.com',//邮箱账号
			'password' 		=> 'insist510153',//邮箱密码
			'from' 			=> '541891006@qq.com',//来自哪儿，一般为邮箱账号即可
			'fromname' 		=> 'wineBuyBuy',//发件人名称
			'altbody' 		=> 'wineBuyBuy注册验证码，如果您看见的是本条内容请与wineBuyBuy管理员联系！',//邮件默认内容，当收件人屏蔽了内容或某些意外情况时展现
		];
