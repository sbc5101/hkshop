<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\phpStudy\WWW\yoshop/application/admin\view\setpay\index.html";i:1488268208;s:64:"D:\phpStudy\WWW\yoshop/application/admin\view\Public\public.html";i:1488347998;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	...
	<div class="col-lg-12">
		<div class="panel panel-default bk-bg-white">
			<div class="panel-heading bk-bg-white">
				<h6><i class="fa fa-table"></i><span class="break"></span>支付列表</h6>
			...
			<div class="col-md-2 pull-right" style="margin:10px 0;">
				<a class="btn btn-success" href="<?php echo url('admin/setpay/add_pay'); ?>">
					<i class="fa fa-plus"></i> 添加支付                                          
				</a>
			...
			<div class="panel-body">
				<div class="table-responsive">	
					<table class="table table-bordered ">
						...
						<tbody>
							<?php if(is_array($data) || $data instanceof \think\Collection): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "<tr><td colspan='3' align='center'>暂无数据</td></tr>" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
							<tr>
								<th colspan="2" >商家账户：<?php echo $vo['seller_name']; ?></th>
							</tr>
							<tr>
								<td>支付宝支付</td>
								<td>
									<a href="<?php echo url('admin/setpay/rev_alipay',['id' => $vo['id']]); ?>" class="btn btn-success" title="修改"><i class="fa fa-pencil"></i> 修改</a>
								</td>
							</tr>
							<tr>
								<td>微信支付</td>
								<td>
									<a href="<?php echo url('admin/setpay/rev_wechat',['id' => $vo['id']]); ?>" class="btn btn-success" title="修改"><i class="fa fa-pencil"></i> 修改</a>
								</td>
							</tr>
							<tr>
								<td>银联支付</td>
								<td>
									<a href="<?php echo url('admin/setpay/rev_union',['id' => $vo['id']]); ?>" class="btn btn-success" title="修改"><i class="fa fa-pencil"></i> 修改</a>
								</td>
							</tr>
							<?php endforeach; endif; else: echo "<tr><td colspan='3' align='center'>暂无数据</td></tr>" ;endif; ?>
						</tbody>
					</table>
				</div>
