...
<!--     <script type="text/javascript" src="/public/admin/assets/js/pages/index.js"></script> -->
 ...
 -->        <!-- Navbar Left -->
	...
	<li class="active">商品区域管理</li>
	<li class="active">商品区域列表</li>
	...
	<div class="col-lg-12">
		<div class="panel panel-default bk-bg-white">
			<div class="panel-heading bk-bg-white">
				<h6><i class="fa fa-table"></i><span class="break"></span>商品区域管理</h6>
			...
			<div class="col-md-1 pull-right" style="margin:10px 0;">
				<a class="btn btn-success" href="<?php echo url('admin/goods/add_area'); ?>">
			...
			<div class="panel-body">
				<div class="table-responsive">	
					<table class="table table-striped table-bordered bootstrap-datatable datatable">
						...
						<tbody>
							<?php if(is_array($data) || $data instanceof \think\Collection): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "<tr><td align='center' colspan='6'>暂无数据</td></tr>" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>	
							<tr class="gradeA odd" role="row">
								<td class="actions"><?php echo $k; ?></td>
								<td class="actions"><?php echo $vo['area_name']; ?></td>
								<?php if($vo['display'] == '1'): ?>
								...
								<td class="actions">
									<a href="<?php echo url('admin/goods/rev_area',['id' => $vo['id']]); ?>" class="on-default edit-row" title="修改"><i class="fa fa-pencil"></i></a>
									<a href="<?php echo url('admin/goods/action_del_area',['id' => $vo['id']]); ?>" class="on-default remove-row" title="删除" onclick="return confirm('确认删除？');return false;"><i class="fa fa-trash-o"></i></a>
								</td>
							</tr>
							<?php endforeach; endif; else: echo "<tr><td align='center' colspan='6'>暂无数据</td></tr>" ;endif; ?>
						</tbody>
					</table>
				</div>
