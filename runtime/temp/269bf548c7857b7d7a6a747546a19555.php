<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\phpStudy\WWW\yoshop/application/admin\view\goods\add_goods.html";i:1488174283;s:64:"D:\phpStudy\WWW\yoshop/application/admin\view\Public\public.html";i:1488347998;}*/ ?>
<!DOCTYPE html>
<html lang="en">
		...
		<div class="panel-body">
			<form action="<?php echo url('admin/goods/action_add_goods'); ?>" method="post" enctype="multipart/form-data">
				<div class="form-group">
					...
					<input type="text" name="gname" class="form-control" value="" placeholder="请输入商品名">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<select name="area_id" class="form-control">
						<?php if(is_array($area_data) || $area_data instanceof \think\Collection): $i = 0; $__LIST__ = $area_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				...
				<div class="form-group">
					...
					<select name="cate_id" class="form-control">
						<?php if(is_array($cate_data) || $cate_data instanceof \think\Collection): $i = 0; $__LIST__ = $cate_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<option value="<?php echo $vo['id']; ?>"><?php echo $vo['new_path']; ?></option>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
				</div>
				...
				<div class="form-group">
					...
					<input type="text" name="productprice" class="form-control" value="" placeholder="元">
				</div>
				<div class="form-group">
					<label for="nf-user">税点</label>
					<input type="text" name="tax_point" class="form-control" value="" placeholder="%">
				</div>
				<div class="form-group">
					<label for="nf-user">零售价</label>
					<input type="text" name="marketprice" class="form-control" value="" placeholder="(基础价+基础价*税点)">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div >
						<div class="radio-custom radio-inline" style="float:left;">
							<span>省代：</span>
							<input style="width:100px;" type="text" name="agentp" class="form-control" value="" placeholder="%"> 
						</div>
						<div class="radio-custom radio-inline">
							<span>市代：</span>
							<input style="width:100px;" type="text" name="agentc" class="form-control" value="" placeholder="%">
						</div>
						<div class="radio-custom radio-inline">
							<span>业务员：</span>
							<input style="width:100px;" type="text" name="agentyy" class="form-control" value="" placeholder="%">
						</div>
					</div>
				</div>
				<div class="form-group">
					<label for="nf-user">备案商品编号</label>
					<input type="text" name="record_num" class="form-control" value="" placeholder="请输入备案商品编号">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div>
						...
						<div class="radio-custom radio-inline" style="padding:0;">
							<input type="text" id="origin-txt" name="origin-txt" class="form-control" value="">
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div>
						...
						<div class="radio-custom radio-inline" style="padding:0;">
							<input type="text" name="level-txt" id="level-txt" class="form-control" value="">
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div>
						...
						<div class="radio-custom radio-inline" style="padding:0;">
							<input type="text" name="variety-txt" id="variety-txt" class="form-control" value="">
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div>
						...
						<div class="radio-custom radio-inline" style="padding:0;">
							<input type="text" name="chateau-txt" id="chateau-txt" class="form-control" value="">
						</div>
					</div>
				</div>
				<div class="form-group">
					<label for="nf-user">口感</label>
					<input type="text" name="taste" class="form-control" value="">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="smell" class="form-control" value="">
				</div>
				<div class="form-group">
					<label for="nf-user">建议醒酒时间</label>
					<input type="text" name="breathing" class="form-control" value="">
				</div>
				<div class="form-group">
					<label for="nf-user">重量</label>
					<input type="text" name="weight" class="form-control" value="0" placeholder="克">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div >
						<div class="radio-custom radio-inline" style="float:left;">
							<input type="radio" id="stock-sta1" name="stock_sta" value="0" checked> 
							<label for="stock-sta1"> 拍下减库存</label>
						</div>
						<div class="radio-custom radio-inline">
							<input type="radio" id="stock-sta2" name="stock_sta" value="1"> 
				...
				<div class="form-group">
					...
					<div>
						<!-- <div class="checkbox-custom checkbox-inline" style="float:left;">
							<input type="checkbox" id="is-new" name="is_new" value="0"> 
							<label for="is-new"> 新品</label>
						</div> -->
						<div class="checkbox-custom checkbox-inline" style="float:left;">
							<input type="checkbox" id="is_hot" name="is_hot" value="0"> 
							<label for="is_hot"> 热卖</label>
						</div>
						<div class="checkbox-custom checkbox-inline">
							<input type="checkbox" id="is_home" name="is_home" value="0"> 
				...
				<div class="form-group">
					...
					<div>
						<div class="checkbox-custom checkbox-inline" style="float:left;">
							<input type="checkbox" id="is-free" name="is_free" value="0"> 
							<label for="is-free">
				...
				<div class="form-group">
					...
					<script id="editor" name="goods_msg" type="text/plain" style="width:750px;height:400px;"></script>
				</div>
				<div class="form-group">
