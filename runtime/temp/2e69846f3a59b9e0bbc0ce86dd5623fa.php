<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\phpStudy\WWW\yoshop/application/admin\view\cates\index.html";i:1483331074;s:64:"D:\phpStudy\WWW\yoshop/application/admin\view\Public\public.html";i:1488347998;}*/ ?>
<!DOCTYPE html>
<html lang="en">
					...
					<table class="table table-striped table-bordered bootstrap-datatable datatable">
						...
						<tbody>	
							...
							<tr>
								...
								<td>
									<a class="btn btn-success" href="<?php echo url('admin/cates/index',['id' => $vo['id']]); ?>">
										<i class="fa fa-search-plus "></i> 查看子类                                            
									</a>
									<?php if($vo['pid'] != '0'): ?>
									<a class="btn btn-success" href="<?php echo url('admin/cates/index',['id' => $pid]); ?>">
									...
									<?php endif; ?>
									<a class="btn btn-info" href="<?php echo url('admin/cates/rev_cate',['id' => $vo['id']]); ?>">
										<i class="fa fa-edit "></i> 修改                                        
									</a>
									<a class="btn btn-danger" href="<?php echo url('admin/cates/action_del_cate',['id' => $vo['id']]); ?>">
