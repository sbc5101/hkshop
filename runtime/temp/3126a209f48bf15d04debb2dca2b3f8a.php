<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\phpStudy\WWW\yoshop/application/admin\view\activity\festival.html";i:1486462615;s:64:"D:\phpStudy\WWW\yoshop/application/admin\view\Public\public.html";i:1488347998;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	...
	<div class="col-lg-12">
		<div class="panel panel-default bk-bg-white">
			<div class="panel-heading bk-bg-white">
				<h6><i class="fa fa-table"></i><span class="break"></span>活动管理</h6>
			...
			<div class="col-md-2 pull-right" style="margin:10px 0;">
				<a class="btn btn-success" href="<?php echo url('admin/activity/add_festival'); ?>">
			...
			<div class="panel-body">
				<div class="table-responsive">	
					<table class="table table-striped table-bordered bootstrap-datatable datatable">
						...
						<tbody>
							<?php if(is_array($data) || $data instanceof \think\Collection): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "<tr><td colspan='9' align='center'>暂无数据</td></tr>" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
							<tr class="gradeA odd" role="row">
								<td class="actions"><?php echo $vo['id']; ?></td>
								<td class="actions"><img src="<?php echo $vo['act_image']; ?>" width="60" height="40" alt="首图"></td>
								<td class="actions"><?php echo $vo['act_title']; ?></td>
								<td class="actions"><?php echo $vo['discount']; ?>%</td>
								<td class="actions"><?php echo $vo['start_time']; ?> ~ <?php echo $vo['end_time']; ?></td>
								<td class="actions"><?php echo $vo['stock']; ?></td>
								<td class="actions"><?php echo $vo['buy_number']; ?></td>
								<td>
								...
								<td class="actions">
									<a href="<?php echo url('admin/activity/rev_festival',['id' => $vo['id']]); ?>" class="on-default edit-row" title="修改"><i class="fa fa-pencil"></i></a>
									<a href="<?php echo url('admin/activity/action_del_fes',['id' => $vo['id']]); ?>" class="on-default remove-row" title="删除" onclick="return confirm('确认删除？');return false;"><i class="fa fa-trash-o"></i></a>
								</td>
							</tr>
							<?php endforeach; endif; else: echo "<tr><td colspan='9' align='center'>暂无数据</td></tr>" ;endif; ?>
						</tbody>
					</table>
				</div>
