<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\phpStudy\WWW\yoshop/application/admin\view\areas\index.html";i:1488167116;s:64:"D:\phpStudy\WWW\yoshop/application/admin\view\Public\public.html";i:1488347998;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	...
	<div class="col-lg-12">
		<div class="panel panel-default bk-bg-white">
			<div class="panel-heading bk-bg-white">
				<h6><i class="fa fa-table"></i><span class="break"></span>区域管理</h6>
			...
			<div class="col-md-2 pull-right" style="margin:10px 0;">
				<a class="btn btn-success" href="<?php echo url('admin/areas/add_area'); ?>">
					...
					<table class="table table-striped table-bordered bootstrap-datatable datatable">
						...
						<tbody>	
							...
							<tr>
								...
								<td><input type="text" name="" value="<?php echo $vo['sort']; ?>"></td>
								<td>
									<a class="btn btn-success" href="<?php echo url('admin/areas/index',['id' => $vo['id']]); ?>">
										<i class="fa fa-search-plus "></i> 查看子类                                            
									</a>
									<?php if($vo['pid'] != '0'): ?>
									<a class="btn btn-success" href="<?php echo url('admin/areas/index',['id' => $pid]); ?>">
										<i class="fa fa-mail-reply "></i> 返回上一级                                           
									</a>
									<a class="btn btn-success" href="<?php echo url('admin/areas/index',['id' => $pid]); ?>">
										<i class="fa fa-home"></i> 返回顶级                                           
									</a>
									<?php endif; ?>
									<a class="btn btn-info" href="<?php echo url('admin/areas/rev_area',['id' => $vo['id']]); ?>">
										<i class="fa fa-edit "></i> 修改                                        
									</a>
									<a class="btn btn-danger" href="<?php echo url('admin/areas/action_del_area',['id' => $vo['id']]); ?>">
