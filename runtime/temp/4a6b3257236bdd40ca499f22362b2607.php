<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\phpStudy\WWW\hkshop/application/admin\view\goods\rev_area.html";i:1501578231;s:64:"D:\phpStudy\WWW\hkshop/application/admin\view\Public\public.html";i:1501574159;}*/ ?>
<!DOCTYPE html>
<html lang="en">
 ...
 -->        <!-- Navbar Left -->
	...
	<li class="active"><a href="<?php echo url('admin/goods/area_list'); ?>">商品区域管理</a></li>
	<li class="active">修改商品区域</li>
	...
	<div class="panel panel-default bk-bg-white col-md-6 col-md-offset-3">
		<div class="panel-heading bk-bg-white">
			<h6><i class="fa fa-indent red"></i>修改商品区域</h6>							
		...
		<div class="panel-body">
			<form action="<?php echo url('admin/goods/action_rev_area'); ?>" method="post">
				<input type="hidden" name="id" value="<?php echo $data['id']; ?>">
				<div class="form-group">
					<label for="nf-user">区域名称*</label>
					<input type="text" name="area_name" class="form-control" value="<?php echo $data['area_name']; ?>" placeholder="请输入区域名">
				</div>
			
				<div class="form-group">
					<label for="nf-password">状态*</label>
					<select id="cate" name="display" class="form-control">
						<option value="0" <?php if($data['display'] == '0'): ?> selected <?php endif; ?>>禁止</option>
						<option value="1"  <?php if($data['display'] == '1'): ?> selected <?php endif; ?>>正常</option>
					</select>
				</div>
