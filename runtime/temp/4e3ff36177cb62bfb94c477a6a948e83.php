<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\phpStudy\WWW\hkshop/application/admin\view\cates\add_cate.html";i:1501470716;s:64:"D:\phpStudy\WWW\hkshop/application/admin\view\Public\public.html";i:1501574159;}*/ ?>
<!DOCTYPE html>
<html lang="en">
 ...
 -->        <!-- Navbar Left -->
	...
	<li class="active"><a href="<?php echo url('admin/cates/index'); ?>">分类管理</a></li>
	...
	<div class="panel panel-default bk-bg-white col-md-6 col-md-offset-3">
		...
		<div class="panel-body">
			<form action="<?php echo url('admin/cates/action_add_cate'); ?>" method="post" enctype="multipart/form-data">
				<div class="form-group">
					<label for="nf-user">分类名称</label>
					<input type="text" name="cname" class="form-control" value="" placeholder="请输入分类名">
				</div>
				<div class="form-group">
					<label for="nf-password">分类路径</label>
				...
				<div class="form-group">
					<label for="nf-password">是否显示</label>
