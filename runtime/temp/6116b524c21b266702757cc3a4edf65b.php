<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\phpStudy\WWW\yoshop/application/admin\view\activity\time_limit.html";i:1486461982;s:64:"D:\phpStudy\WWW\yoshop/application/admin\view\Public\public.html";i:1488347998;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	...
	<div class="col-lg-12">
		<div class="panel panel-default bk-bg-white">
			...
			<div class="col-md-2 pull-right" style="margin:10px 0;">
				<a class="btn btn-success" href="<?php echo url('admin/activity/add_tlimit'); ?>">
					...
					<table class="table table-striped table-bordered bootstrap-datatable datatable">
						...
						<tbody>
							...
							<tr class="gradeA odd" role="row">
								...
								<td class="actions"><?php echo $vo['act_price']; ?></td>
								...
								<td class="actions">
									<a href="<?php echo url('admin/activity/rev_tlimit',['id' => $vo['id']]); ?>" class="on-default edit-row" title="修改"><i class="fa fa-pencil"></i></a>
									<a href="<?php echo url('admin/activity/action_del_tlimit',['id' => $vo['id']]); ?>" class="on-default remove-row" title="删除" onclick="return confirm('确认删除？');return false;"><i class="fa fa-trash-o"></i></a>
								</td>
							</tr>
