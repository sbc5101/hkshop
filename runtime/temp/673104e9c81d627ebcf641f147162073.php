<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\phpStudy\WWW\yoshop/application/admin\view\activity\rev_festival.html";i:1486464782;s:64:"D:\phpStudy\WWW\yoshop/application/admin\view\Public\public.html";i:1488347998;}*/ ?>
<!DOCTYPE html>
<html lang="en">
 ...
 -->        <!-- Navbar Left -->
	...
	<li class="active"><a href="<?php echo url('admin/activity/festival'); ?>">节日促销</a></li>
	<li class="active">修改节日促销</li>
	...
	<div class="panel panel-default bk-bg-white col-md-6 col-md-offset-3">
		<div class="panel-heading bk-bg-white">
			<h6><i class="fa fa-indent red"></i>修改节日促销</h6>							
		...
		<div class="panel-body">
			<form action="<?php echo url('admin/activity/action_rev_festival'); ?>" method="post" enctype="multipart/form-data">
				<input type="hidden" name="id" value="<?php echo $activity['id']; ?>">
				<div class="form-group">
					<label for="nf-password">活动名称</label>
					<input type="text" name="act_title" class="form-control" value="<?php echo $activity['act_title']; ?>" placeholder="请输入活动名称">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="nf-user">是否开启</label>
					<div >
						<div class="radio-custom radio-inline" style="float:left;">
							<input type="radio" id="status1" name="is_close" value="0" <?php if($activity['is_close'] == '0'): ?> checked <?php endif; ?>> 
							<label for="status1"> 开启</label>
						</div>
						<div class="radio-custom radio-inline">
							<input type="radio" id="status2" name="is_close" value="1" <?php if($activity['is_close'] == '1'): ?> checked <?php endif; ?>> 
							<label for="status2"> 关闭</label>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label for="nf-password">活动开始时间</label>
					<input type="text" name="start_time" class="form-control" value="<?php echo $activity['start_time']; ?>" placeholder="请设置活动开始时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
				</div>
				<div class="form-group">
					<label for="nf-password">活动结束时间</label>
					<input type="text" name="end_time" class="form-control" value="<?php echo $activity['end_time']; ?>" placeholder="请设置活动结束时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
				</div>
				<div class="form-group">
					<label for="nf-user">活动优惠/%</label>
					<input type="text" name="discount" class="form-control" value="<?php echo $activity['discount']; ?>" placeholder="请输入活动优惠/%">
				</div>
				<div class="form-group">
					<label for="nf-user">库存</label>
					<input type="text" name="stock" class="form-control" value="<?php echo $activity['stock']; ?>" placeholder="请输入库存">
				</div>
				<div class="form-group">
					<label for="nf-user">是否限购</label>
					<div>
						<div class="radio-custom radio-inline" style="padding:0;">
							<input type="text" id="buy_number" name="buy_number" class="form-control" placeholder="请输入限制购买数量" value="<?php echo $activity['buy_number']; ?>">
						</div>
						0不限购
					</div>
				</div>
				<div class="form-group">
					...
					<br>
					<img src="<?php echo $activity['act_image']; ?>" alt="" width="150" height="100">
					<br>
				...
				<div class="form-group">
					...
					<input type="text" name="sort" class="form-control" value="<?php echo $activity['sort']; ?>" maxlength="3">
				</div>
