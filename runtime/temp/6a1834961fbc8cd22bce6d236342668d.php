<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\phpStudy\WWW\yoshop/application/admin\view\activity\rev_tlimit.html";i:1486463942;s:64:"D:\phpStudy\WWW\yoshop/application/admin\view\Public\public.html";i:1488347998;}*/ ?>
<!DOCTYPE html>
<html lang="en">
 ...
 -->        <!-- Navbar Left -->
	...
	<li class="active"><a href="<?php echo url('admin/activity/time_limit'); ?>">限时抢购</a></li>
	<li class="active">修改限时抢购</li>
	...
	<div class="panel panel-default bk-bg-white col-md-6 col-md-offset-3">
		<div class="panel-heading bk-bg-white">
			<h6><i class="fa fa-indent red"></i>修改限时抢购</h6>							
		...
		<div class="panel-body">
			<form action="<?php echo url('admin/activity/action_rev_tlimit'); ?>" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input type="text" name="end_time" class="form-control" value="<?php echo $activity['start_time']; ?>" placeholder="请设置活动结束时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
				</div>
				<div class="form-group">
					<label for="nf-user">活动价格</label>
					<input type="text" name="act_price" class="form-control" value="<?php echo $activity['act_price']; ?>" placeholder="请输入活动价格">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div>
						<div class="radio-custom radio-inline" style="padding:0;">
							<input type="text" id="buy_number" name="buy_number" class="form-control" placeholder="请输入限制购买数量" value="0">
						</div>
							0不限购
					</div>
				</div>
