<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\phpStudy\WWW\hkshop/application/admin\view\member\users.html";i:1501481689;s:64:"D:\phpStudy\WWW\hkshop/application/admin\view\Public\public.html";i:1501479042;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="panel panel-default bk-bg-white">
			<div class="panel-heading bk-bg-white">
				<h6><i class="fa fa-table red"></i><span class="break"></span>会员列表</h6>							
			...
			<div class="panel-body">
				...
				<div class="table-responsive" style="margin-top: 50px;">
					<table class="table table-bordered table-striped" >
						...
						<tbody>
							<?php if(is_array($new_data) || $new_data instanceof \think\Collection): $i = 0; $__LIST__ = $new_data;if( count($__LIST__)==0 ) : echo "<tr><td colspan=" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>	
							<tr class="gradeA odd" role="row">
								...
								<?php endif; ?>
								<td class="actions">
									<a href="<?php echo url('admin/member/rev_user',['id' => $vo['id']]); ?>" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
									<?php if($vo['is_close'] == '0'): ?>
									<a href="<?php echo url('admin/member/action_rev_status',['id' => $vo['id'],'is_close' => $vo['is_close']]); ?>" title="禁止" onclick="return confirm('确认禁止？');return false;" class="on-default remove-row"><i class="glyphicon glyphicon-remove"></i></a>
									<?php else: ?>
									<a href="<?php echo url('admin/member/action_rev_status',['id' => $vo['id'],'is_close' => $vo['is_close']]); ?>" title="开启" onclick="return confirm('确认开启？');return false;" class="on-default remove-row"><i class="glyphicon glyphicon-ok"></i></a>
									<?php endif; ?>
								</td>
							</tr>
