<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\phpStudy\WWW\yoshop/application/admin\view\member\add_user.html";i:1483001107;s:64:"D:\phpStudy\WWW\yoshop/application/admin\view\Public\public.html";i:1488347998;}*/ ?>
<!DOCTYPE html>
<html lang="en">
 ...
 -->        <!-- Navbar Left -->
	...
	<div class="panel panel-default bk-bg-white col-md-6 col-md-offset-3">
		...
		<div class="panel-body">
			<form action="<?php echo url('admin/power/action_add_user'); ?>" method="post">
				<div class="form-group">
					<label for="nf-user">用户名</label>
					<input type="user" id="nf-user" name="name" class="form-control" placeholder="请输入用户名">
				</div>
				<div class="form-group">
					<label for="nf-password">密码</label>
					<input type="password" id="nf-password" name="password" class="form-control" placeholder="请输入密码">
				</div>
				<div class="form-group">
					<label for="nf-password">确认密码</label>
					<input type="password" id="nf-password" name="repassword" class="form-control" placeholder="请再次输入密码">
				</div>
				<div class="form-group">
					<label for="email">邮箱</label>
					<input type="email" id="nf-email" name="email" class="form-control" placeholder="请输入邮箱号">
				</div>
