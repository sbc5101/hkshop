<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\phpStudy\WWW\yoshop/application/admin\view\activity\add_tlimit.html";i:1486455256;s:64:"D:\phpStudy\WWW\yoshop/application/admin\view\Public\public.html";i:1488347998;}*/ ?>
<!DOCTYPE html>
<html lang="en">
 ...
 -->        <!-- Navbar Left -->
	...
	<div class="panel panel-default bk-bg-white col-md-6 col-md-offset-3">
		<div class="panel-heading bk-bg-white">
			<h6><i class="fa fa-indent red"></i>添加限时抢购</h6>							
		...
		<div class="panel-body">
			<form action="<?php echo url('admin/activity/action_add_tlimit'); ?>" method="post" enctype="multipart/form-data">
				<div class="form-group">
					<label for="nf-password">活动名称</label>
					<input type="text" name="act_title" class="form-control" value="" placeholder="请输入活动名称">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div >
						<div class="radio-custom radio-inline" style="float:left;">
							<input type="radio" id="status1" name="is_close" value="0" checked> 
							<label for="status1"> 开启</label>
						</div>
						<div class="radio-custom radio-inline">
							<input type="radio" id="status2" name="is_close" value="1"> 
				...
				<div class="form-group">
					...
					<input type="text" name="start_time" class="form-control" value="" placeholder="请设置活动开始时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
				</div>
				<div class="form-group">
					<label for="nf-password">活动结束时间</label>
					<input type="text" name="end_time" class="form-control" value="" placeholder="请设置活动结束时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
				</div>
				<div class="form-group">
					<label for="nf-user">活动优惠</label>
					<input type="text" name="act_price" class="form-control" value="" placeholder="请输入活动价格">
				</div>
				<div class="form-group">
					<label for="nf-user">库存</label>
					<input type="text" name="stock" class="form-control" value="0" placeholder="请输入库存">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="nf-user">是否轮播图</label>
					<div >
						<div class="radio-custom radio-inline" style="float:left;">
							<input type="radio" id="is_carousel1" name="is_carousel" value="0"> 
							<label for="is_carousel1"> 是</label>
						</div>
						<div class="radio-custom radio-inline">
							<input type="radio" id="is_carousel2" name="is_carousel" value="1" checked> 
							<label for="is_carousel2"> 否</label>
						</div>
					</div>
				</div>
				<div class="form-group">
