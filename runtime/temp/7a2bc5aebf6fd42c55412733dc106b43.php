<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\phpStudy\WWW\yoshop/application/admin\view\member\users.html";i:1483685003;s:64:"D:\phpStudy\WWW\yoshop/application/admin\view\Public\public.html";i:1488347998;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="panel panel-default bk-bg-white">
			...
			<div class="panel-body">
					...
					<form action="<?php echo url('admin/member/users'); ?>" method="get">
						<label>
					...
					<thead>
						<tr role="row">
							<th class="sorting_asc" tabindex="0" aria-controls="datatable-editable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Template: activate to sort column ascending" style="width: 164px;">用户名</th>
							<th class="sorting_disabled" rowspan="1" colspan="1" aria-label="Actions" style="width: 129px;">性别</th>
							<th class="sorting" tabindex="0" aria-controls="datatable-editable" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 260px;">手机号</th>
							<th class="sorting" tabindex="0" aria-controls="datatable-editable" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 226px;">邮箱</th>
							<th class="sorting_disabled" rowspan="1" colspan="1" aria-label="Actions" style="width: 229px;">注册时间</th>
							<th class="sorting_disabled" rowspan="1" colspan="1" aria-label="Actions" style="width: 129px;">状态</th>
							<th class="sorting_disabled" rowspan="1" colspan="1" aria-label="Actions" style="width: 129px;">操作</th>
						</tr>
					</thead>
					<tbody>
						<?php if(is_array($data) || $data instanceof \think\Collection): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>
						<tr class="gradeA odd" role="row">
							<td class="sorting_1"><?php echo $user['user_name']; ?></td>
							<?php if($user['sex'] == '0'): ?>
							<td>男</td>
							<?php else: ?>
							<td>女</td>
							...
							<?php endif; ?>
							<td class="actions">
								<!-- <a href="<?php echo url('admin/power/rev_user',['id' => $user['id']]); ?>" class="on-default edit-row"><i class="fa fa-pencil"></i></a> -->
								<a href="<?php echo url('admin/member/action_rev_status',['id' => $user['id'],'status' => $user['status']]); ?>" title="禁止" onclick="return confirm('确认禁止？');return false;" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
							</td>
						</tr>
