<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\phpStudy\WWW\yoshop/application/admin\view\goods\index.html";i:1486202172;s:64:"D:\phpStudy\WWW\yoshop/application/admin\view\Public\public.html";i:1488347998;}*/ ?>
<!DOCTYPE html>
<html lang="en">
					...
					<table class="table table-striped table-bordered bootstrap-datatable datatable">
						...
						<tbody>
							...
							<tr class="gradeA odd" role="row">
								...
								<td class="actions"><img src="<?php echo $vo['iname']; ?>" width="30" height="30" alt="首图"></td>
								<td class="actions"><?php echo $vo['title']; ?></td>
								...
								<td>
									<?php switch($vo['type']): case "0": ?><span class="label label-info">跨境商品</span><?php break; case "1": ?><span class="label label-info">完税商品</span><?php break; case "2": ?><span class="label label-info">免税商品</span><?php break; endswitch; ?>
									<!-- <?php if($vo['is_new'] == '0'): ?>
									<span class="label label-success">新品</span>
									<?php endif; ?> -->
									<?php if($vo['is_hot'] == '0'): ?>
									<span class="label label-success">热销</span>
									<?php endif; if($vo['is_home'] == '0'): ?>
									<span class="label label-success">首页推荐</span>
									<?php endif; if($vo['is_free'] == '0'): ?>
								...
								<td class="actions">
									<a href="<?php echo url('admin/goods/rev_goods',['id' => $vo['id'],'status' => '1']); ?>" class="on-default edit-row" title="修改"><i class="fa fa-pencil"></i></a>
									<a href="<?php echo url('admin/goods/rev_images',['id' => $vo['id']]); ?>" class="on-default remove-row" title="图片管理"><i class="fa fa-picture-o"></i></a>
