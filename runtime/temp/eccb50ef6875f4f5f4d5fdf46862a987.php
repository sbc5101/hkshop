<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\phpStudy\WWW\yoshop/application/admin\view\seller\add_seller.html";i:1488359079;s:64:"D:\phpStudy\WWW\yoshop/application/admin\view\Public\public.html";i:1488347998;}*/ ?>
<!DOCTYPE html>
<html lang="en">
 ...
 -->        <!-- Navbar Left -->
	...
	<div class="panel panel-default bk-bg-white col-md-10 col-md-offset-1">
		<div class="panel-heading bk-bg-white">
			<h6><i class="fa fa-indent red"></i>添加商户</h6>							
		...
		<div class="panel-body">
			<form action="<?php echo url('admin/seller/action_add_seller'); ?>" method="post">
				<div class="form-group">
					<label>用户名</label>
					<input type="text" name="seller_name" class="form-control" placeholder="请输入商户名">
				</div>
				<div class="form-group">
					<label>密码</label>
				...
				<div class="form-group">
					<label>商户全称</label>
					<input type="text" name="true_name" class="form-control" placeholder="请输入商户全称">
				</div>
				<div class="form-group">
					<label>固定电话</label>
				...
				<div class="form-group">
					<label>邮箱</label>
					<input type="text" name="email" class="form-control" placeholder="请输入邮箱号">
				</div>
				<div class="form-group">
					<label>地区</label>
					<div>
				...
				<div class="form-group" style="margin-top: 15px;">
					<label>详细地址</label>
					<input type="text" name="address" class="form-control" placeholder="请填写详细地址">
				</div>
				<div class="form-group">
					...
					<div >
						<div class="radio-custom radio-inline" style="float:left;">
							<span>开户账号</span>
							<input style="width:250px;" type="text" name="account_user" class="form-control" value="" > 
						</div>
						<div class="radio-custom radio-inline">
							<span>开户银行</span>
							<input style="width:200px;" type="text" name="account_bank" class="form-control" value="" >
						</div>
						<div class="radio-custom radio-inline">
							<span>开户姓名</span>
							<input style="width:150px;" type="text" name="account_name" class="form-control" value="">
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div >
						<div class="radio-custom radio-inline" style="float:left;">
							<input type="radio" id="status1" name="is_lock" value="0" checked> 
							<label for="status1"> 正常</label>
						</div>
						<div class="radio-custom radio-inline">
							<input type="radio" id="status2" name="is_lock" value="1"> 
							<label for="status2"> 锁定</label>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label for="nf-user">添加售货机</label>
					<div>
						<div class="btn btn-success pull-left"  id="add-machine">添加</div>
					</div>
				</div>
				<br>
				<br>
				<button type="submit" class="btn btn-primary col-md-3 pull-right">确认</button>
			<div id="machines" class="panel panel-default bk-bg-white col-md-3 col-md-offset-1" style="position: fixed;left: 30%;top:30%;display: none;">
				<div class="panel-heading bk-bg-white">
					<h6><i class="fa fa-indent red"></i>添加售货机</h6>							
					<div class="panel-actions">
						<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
						<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
					</div>
				...
				<div class="panel-body">
					<div class="form-group">
						<div class="col-lg-8">
							<?php if(is_array($machine) || $machine instanceof \think\Collection): $i = 0; $__LIST__ = $machine;if( count($__LIST__)==0 ) : echo "<h2>暂无可绑定机器数据！</h2>" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
							<label class="checkbox-inline">
                              <input type="checkbox" id="inlineCheckbox1" name="machine[]" value="<?php echo $vo['id']; ?>"> <?php echo $vo['machine_name']; ?>
                            </label>
                            <br>
                            <br>
							<?php endforeach; endif; else: echo "<h2>暂无可绑定机器数据！</h2>" ;endif; ?>
                           
                          </div>
					</div>
					<br>
					<br>
					<div class="btn btn-primary col-md-3 pull-right" id="confirm-mac">确认</div>
				</div>								
			</div>
			</form>
		</div>								
